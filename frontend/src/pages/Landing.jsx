...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white" style={{ position: 'relative' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Real-Time Detection', description: 'AI-powered threat analysis blocking malicious domains instantly' },
              { title: 'Zero Trust Architecture', description: 'Device trust scores and behavioral biometrics for access control' },
              { title: 'Privacy First', description: 'Only domain names stored, never page content or passwords' },
              { title: 'Federated Learning', description: 'Collaborative threat intelligence without sharing raw data' },
              { title: 'Custom Firewall Rules', description: 'Define your own security policies with an intuitive interface' },
              { title: 'Dark Web Monitoring', description: 'Threat intelligence from multiple feeds, updated in real-time' },
            ].map((feature, idx) => (
              <div key={idx} className="bg-neutral-800/80 backdrop-blur-sm p-8 rounded-lg border border-neutral-700 hover:border-cyan-600/50 transition">
        ...
        {/* Install Section */}
        <section id="install" className="bg-neutral-800/40 backdrop-blur-sm py-20">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-4xl font-bold mb-12 text-center">Get Started</h2>
            <div className="bg-neutral-900/80 rounded-lg p-12 border border-neutral-700 max-w-2xl mx-auto">
