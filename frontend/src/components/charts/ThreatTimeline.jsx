      ...
      {hasData ? (
        <ResponsiveContainer width="100%" height={240}>
          <BarChart data={data} barGap={4}>
            ...
            <Legend wrapperStyle={{ fontSize:12, color:'#475569', paddingTop:12 }} iconType="circle" iconSize={8} />
        ...
        <div style={{
          ...
          <p style={{ fontSize:13, color:'#64748b', margin:'6px 0 0', maxWidth:340, lineHeight:1.6 }}>
            Start browsing with the extension active to see your 7-day threat timeline.
          </p>
        </div>
      )}
    </div>
