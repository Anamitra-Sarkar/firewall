...
const COLORS = ['#f43f5e', '#f97316', '#06b6d4', '#6366f1'];
...
const CustomTooltip = ({ active, payload }) => {
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: 13, fontWeight: 700, color: payload[0].payload.fill, margin: 0 }}>
...
export default function TopThreats({ threats }) {
  // Build distribution from real threat data
  const buildData = () => {
    const counts = {};
